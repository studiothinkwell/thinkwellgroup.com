...
$id = projects_get($_REQUEST , 'project_id' , 0 );
  ...
  $query = " SELECT id, image FROM druprojects_images WHERE project_id = '$id' ";
...
<form name="drupal_form" id="drupal_form" action="index.php?q=projects/save" method="post" enctype="multipart/form-data" onsubmit="return modifyUploadNo()">
    <table>
        <tr>
            <td valign="top">
            ...
            <td>
                <input id="title" type="text" class="input_box" name="title" value="<?php echo $row['title'] ?>" maxlength="64" />
            </td>
        </tr>
  		<tr>
            <td valign="top"><label for="project_bio_last_name">Homepage title</label></td>
            <td><input type="text" id="project_bio_last_name" name="project_bio_last_name" class="input_box" value="<?php echo $row['project_bio_last_name'] ?>" maxlength="64" /></td>
        </tr>
		<tr>
        ...
        <tr>
            ...
            <td><input type="text" id="project_bio_first_name" name="project_bio_first_name" class="input_box" value="<?php echo $row['project_bio_first_name'] ?>" maxlength="64" /></td>
        </tr>
        ...
        <tr>
            <td>Video</td>
            <td><input type="file" id="video" name="video" value="<?php echo $row['video'] ?>" /><?php echo $row['video'] ?> (.flv files are only supported for uploading)</td>
        </tr>
