...
$id = campaign_get($_REQUEST , 'campaign_id' , 0 );
  ...
  $query = " SELECT c.id , c.`campaign_title` , cc.content_field FROM campaign c
  ...
  $query = " SELECT `image` FROM drujobs WHERE campaign_id = $id ";
...
<form name="drupal_form" action="index.php?q=campaign/save" method="post" enctype="multipart/form-data" onsubmit="modifyUploadNo()">
    <table>
        <tr>
            <td valign="top">
            ...
            <td>
                <input id="campaign_title" type="text" name="campaign_title" value="<?php echo $row['campaign_title'] ?>" class="input_box" maxlength="64" />
            </td>
        </tr>
                        ...
                        ?>
                                <tr>
                                    <td>
                                        ...
                                        <img src="misc/gallery/<?php echo $images['image'] ?>"  />
                                        <?php
                                            //echo $images['image'];
                                        ?>
                                    </td>
...
?>
    ...
    <tr>
        <td valign="top"><label for="banner1description" >Short Description</label></td>
        <td><textarea id="banner1description" name="banner1[description]" cols="20" rows="5" class="input_textarea"><?php echo $getBanner1['description'] ?></textarea></td>
    </tr>
    <tr>
