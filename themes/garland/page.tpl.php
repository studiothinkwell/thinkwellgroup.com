...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>">
	<head>
        ...
        <script type="text/javascript">
			<!--
				var applicationUrl="http://www.dev.thinkwellgroup.com/";
				function unhideBody()
				{
    ...
    <body>
        ...
        <?php
			...
			if($page_not_found)
			{
				...
				if($row->background)
						$background = $base_url.'/misc/page_background/'.$row->background;
				else
        ...
        <div id="slide_div" class="<?php echo $class ?>">
        	...
        	<div id="wrapper">
        		...
        		<div id="main-wrapper">
            		<div id="center">
                		<?php if($custom_page_not_found) {
                            
                            $queryPageNotFound = "SELECT body FROM drunode_revisions WHERE nid = 25 "; 
                            $rsPageNotFound = db_query($queryPageNotFound);
                            $rowPageNotFound = db_fetch_object($rsPageNotFound);
                            
                            if($rowPageNotFound->body) {
                             
                                echo '<div class="node" id="node-25"><div class="content clear-block">';
                                echo $rowPageNotFound->body;
                                echo '</div></div>';
                            }   
