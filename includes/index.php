...
<script language="Javascript" type="text/javascript">
	...
	searchControl.addSearcher(new google.search.LocalSearch(), options);
      ...
      localSearch.setCenterPoint("Los Angeles, LA");
...
<body>
<div id="mainContainer" style="margin-left:30px;">
...
<h2>Playlist</h2>
  ...
  <div class="errorbox-good">
    <div class="ss-item ss-item-required ss-text">
      ...
      <div class="">
        <input name="txtname" id="entry_4" type="text">
      </div>
    </div>
  </div>
  <br>
  <div class="errorbox-good">
    <div class="ss-item ss-item-required ss-paragraph-text">
      <div class="ss-form-entry">
        ...
        <textarea name="txtbd" rows="8" cols="75" class="ss-q-long" id="entry_3" title="Enter Value...." onClick="try();"> </textarea>
      </div>
    </div>
  </div>
    ...
    <div class="ss-item ss-item-required ss-checkbox">
      <div class="ss-form-entry">
        ...
        <ul class="ss-choices">
          <li class="ss-choice-item">
            <label class="ss-choice-label">
              <input name="txtrange[]" value="All Ages" class="ss-q-checkbox" id="group_10_1" type="checkbox">
              All Ages</label>
          </li>
          <li class="ss-choice-item">
            <label class="ss-choice-label">
